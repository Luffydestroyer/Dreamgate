...
const DialogueSystemPreload = preload("res://scenes/dialogue.tscn")
...
var dialogue_top_pos: Vector2 = Vector2(160, 40)
var dialogue_bot_pos: Vector2 = Vector2(160, 192)
...
func _activate_dialogue():
	...
	if override_dialogue_position:
		...
		if player_node.global_position.y > get_viewport().get_camera_2d().get_screen_center_position().y:
			...
			desired_dialogue_pos = dialogue_bot_pos
